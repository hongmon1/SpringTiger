...
public class DataBaseOpenHelper extends SQLiteOpenHelper {
   ...
   */
   ...
   public DataBaseOpenHelper(Context context) throws IOException {
       ...
       this.DB_PATH = mycontext.getApplicationContext().getPackageName()+"/databases/";
       boolean dbexist = checkdatabase();
       if(dbexist){
           opendatabase();
       }else{
           Log.d(this.getClass().getName(), "Database doesn't exist");
           createdatabase();
       }
   }
   ...
   private void copydataabase() throws  IOException{
       InputStream myinput = mycontext.getAssets().open(DB_NAME);
       String outfilename = DB_PATH + DB_NAME;
       OutputStream myoutput = new FileOutputStream("/data/data/SpringTigersApp/databases/test.db");
   ...
   private final static String mDBFileName = "test2.db";


   public DataBaseOpenHelper(Context context){
       super(context, mDBFileName, null,1 );
       mContext = context;
       //mFolderPath = Environment.getExternalStoragePublicDirectory(null)+"/Android/data/"+context.getPackageName()+"/";
