...
public class DBOpenHelper {
    ...
    //name으로 Favorite table에서 삭제
    public boolean deleteFavColumn(String name){
        return mDB.delete(Databases.CreateFavorite._TABLENAME,"myrecipe_name=?", new String[]{name})>0;
    }
